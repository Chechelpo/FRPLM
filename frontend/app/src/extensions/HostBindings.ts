...
} from "@extensions/registerPrimitiveEditors.js";

/**
 * Local stand-in for the eventual `ExtensionConfig` type that
 * @frplm/host-sdk will publish. The current SDK version does not
 * expose one, so this lives here until the host binding contract
 * is finalised.
 */
...
import {
    ...
    type FrplmExtensionBindings,
    type FrplmHostBindings,
} from "@frplm/host-sdk";
