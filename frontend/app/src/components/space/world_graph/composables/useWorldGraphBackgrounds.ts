import {     EntityAssetType } from "@frplm/host-sdk";
import {computed, type ComputedRef, onBeforeUnmount, type Ref, shallowRef, watch,} from "vue";
import type {Region, World} from "@frplm/host-sdk";
import type {BackgroundTarget, WorldGraphData} from "../types.js";
import {regionEntityKey} from "../utils/geometry.js";
