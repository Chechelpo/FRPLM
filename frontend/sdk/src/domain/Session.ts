...
import {Location, LocationData, LocationKey, World, WorldData, WorldKey} from "../domain/World.js";
import {Character, CharacterData, CharacterKey} from "../domain/Characters.js";
import {DTO, PromptDTO} from "../types/DTOs.js";
import {PromptTemplate, PromptTemplateData, PromptTemplateKey} from "../domain/Prompts.js";
import {ChatCompletionRequest, ChatCompletionRole} from "../types/ChatCompletions.js";
...
export class Message extends ABSEntity<MessagesKey, MessageData>{
    ...
    override async update<F extends keyof MessageData>(field: F, value: MessageData[F]): Promise<boolean> {
