...
import {FieldInfo} from "../core/FieldMetadata.js";
import {CommonFields} from "../utils/CommonFields.js";
import {ValueComparable} from "../types/Equatable.js";
...
import {ReferenceCodec, ReferenceParsers} from "../utils/ReferenceCodec.js";
import {fetchApi} from "../services/apiClient.js";
import {reactive} from "vue";

/**
 * Re-export of the JSON-safe primitive types from `types/DTOs.ts`.
 *
 * These types live in `DTOs.ts` because that is the canonical home
 * for the wire-format types. They are re-exported here for the
 * convenience of the `ABSEntity` consumers, which use them in
 * generics.
 */
export type { Primitives, KeyRecord, DataRecord, EntityField };
