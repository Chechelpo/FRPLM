...
public class Worlds extends TableImpl<WorldsRecord> {
    ...
    private transient LocationsPath _constraint_5e;

    /**
     * Get the implicit to-many join path to the <code>PUBLIC.LOCATIONS</code>
     * table, via the <code>CONSTRAINT_5E</code> key
     */
    public LocationsPath constraint_5e() {
        if (_constraint_5e == null)
            _constraint_5e = new LocationsPath(this, null, Keys.CONSTRAINT_5E.getInverseKey());
    ...
    private transient LocationsPath _fkLocationToWorld;

    /**
     * Get the implicit to-many join path to the <code>PUBLIC.LOCATIONS</code>
     * table, via the <code>FK_LOCATION_TO_WORLD</code> key
     */
    public LocationsPath fkLocationToWorld() {
        if (_fkLocationToWorld == null)
            _fkLocationToWorld = new LocationsPath(this, null, Keys.FK_LOCATION_TO_WORLD.getInverseKey());
