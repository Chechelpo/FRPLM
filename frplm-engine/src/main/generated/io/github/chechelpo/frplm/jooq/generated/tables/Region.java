...
public class Region extends TableImpl<RegionRecord> {
     ...
     */
    public final TableField<RegionRecord, Integer> X = createField(DSL.name("X"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>PUBLIC.REGION.Y</code>.
     */
    public final TableField<RegionRecord, Integer> Y = createField(DSL.name("Y"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");
