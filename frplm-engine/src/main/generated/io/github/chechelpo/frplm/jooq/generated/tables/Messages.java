...
public class Messages extends TableImpl<MessagesRecord> {
    ...
    /**
     * The column <code>PUBLIC.MESSAGES.REASONING</code>.
     */
    public final TableField<MessagesRecord, String> REASONING = createField(DSL.name("REASONING"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>PUBLIC.MESSAGES.IS_ENABLED</code>.
     */
    public final TableField<MessagesRecord, Boolean> IS_ENABLED = createField(DSL.name("IS_ENABLED"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field(DSL.raw("TRUE"), SQLDataType.BOOLEAN)), this, "");
    ...
    public LocationsPath locations() {
        if (_locations == null)
            _locations = new LocationsPath(this, Keys.FK_MESSAGE_TO_LOCATION, null);
