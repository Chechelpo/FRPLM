 ...
 * creationPayload or a structured failure describing the offending field or value.</p>
 *
...
public interface FieldValidator<R extends TableRecord<R>> {
    ...
    /**
     * Validates a creationPayload used to update an existing entity.
     *
     ...
     *
     * <p>Key fields are not permitted in an update creationPayload.</p>
     *
     ...
     *
     * @param payload the update creationPayload to validate
     * @return a successful result containing {@code creationPayload}, or a failure
    ...
    /**
     * Validates a creationPayload used to create a new entity.
     *
     ...
     * configured default values to fields that are absent from the creationPayload.
     * Once defaults have been applied, every field marked as required for
     * creation must be present.</p>
     *
     * @param payload the creation creationPayload to validate and potentially augment
