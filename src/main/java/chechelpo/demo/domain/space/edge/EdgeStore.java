...
import static chechelpo.demo.jooq.generated.tables.LocationNeighbors.LOCATION_NEIGHBORS;
...
final class EdgeStore extends ABSEntityStore<LocationNeighborsRecord> {
    ...
    @Override
    protected boolean update(@NotNull EntityKey<LocationNeighborsRecord> id, @NotNull EntityDataPayload<LocationNeighborsRecord> object) {

        return super.update(id, object);
    }

    @Override
    protected LocationNeighborsRecord createAndGet(@NotNull EntityDataPayload<LocationNeighborsRecord> data) {
        /*
