...
import chechelpo.demo.utils.format.StandardFormats;
...
public class EntityKey<R extends TableRecord<R>>
{
    ...
    public static class Builder<R extends TableRecord<R>> {
        ...
        public Builder<R> setAll(@NotNull Map<TableField<R, ?>, Object> values){
            for (Map.Entry<TableField<R, ?>, Object> entry : values.entrySet()) {
                this.set(entry.getKey(), entry.getValue());
            }
            return this;
        }
        public Builder<R> set(TableField<R, ?> field, Object value){
